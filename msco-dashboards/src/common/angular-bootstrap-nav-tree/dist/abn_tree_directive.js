(function() {
  ...
  module.controller('abnTreeCtrl', function() {
    ...
    '$timeout', function($timeout) {
      return {
        ...
        link: function(scope, element, attrs) {
          ...
          function setInitialSelection(initialSelection) {
              for_each_branch(function(b) {
          ...
          if (attrs.initialSelection != null) {
            setInitialSelection(attrs.initialSelection);
          }
          ...
          if (scope.treeControl != null) {
            if (angular.isObject(scope.treeControl)) {
              ...
              tree.set_initial_branch = function(branch) {
                  $timeout(function() {
                      setInitialSelection(branch);
                  }, 0);
              };
