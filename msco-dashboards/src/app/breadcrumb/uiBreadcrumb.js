angular.module('dashboard.breadcrumbs', [
    'ui.router'
])


.controller('UiBreadcrumbsCtrl', ['$scope', function($scope) {
    $scope.selectedExercise = $scope.$parent.selectedExercise;

    this.getSelectedExercise = function() {
...
.directive('uiBreadcrumbs', function ($interpolate, $state) {
    return {
        restrict: 'E',
        templateUrl: 'breadcrumb/uiBreadcrumb.tpl.html',
        scope: {
            displaynameProperty: '@',
            abstractProxyProperty: '@?'
        },
        controller: 'UiBreadcrumbsCtrl',
        link: function (scope, element, attr, crumbCtrl) {
            scope.breadcrumbs = [];
            ...
            function updateBreadcrumbsArray() {
                var workingState;
                var displayName;
                var breadcrumbs = [];//crumbCtrl.breadcrumbs;
